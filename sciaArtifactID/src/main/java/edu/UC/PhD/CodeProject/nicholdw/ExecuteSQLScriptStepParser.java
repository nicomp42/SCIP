...
public class ExecuteSQLScriptStepParser {	
	public static ExecuteSQLScriptStep parseXMLByStepName(Document doc, XPath xpath, String stepname, String xmlFilename){
		
		ExecuteSQLScriptStep stepObject=null;
         ...
         stepObject=new ExecuteSQLScriptStep(transname,stepname, dbname, sql, xmlFilename);
		return stepObject;
	}
